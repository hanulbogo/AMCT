function [Salpix ,PP]=PropAMC_OneDirection_Hops(img,PP,OF_PC,OF_CP,SupFlag)
%PP.img;
%PP.pK;
%PP.ConPixDouble;
%PP.SupCol;
...
global nhops;
% if nhops ==1
%     SP.ConPixAll =[[PP.ConPix, PC_Conpix] ; [CP_Conpix, ConPix]];
% elseif nhops==2
%     SP.ConPixAll =[[PP.ConPixDouble, PC_Conpix] ; [CP_Conpix, ConPixDouble]];
% elseif nhops==3
%     SP.ConPixAll =[[PP.ConPixDouble*PP.ConPix, PC_Conpix] ; [CP_Conpix, ConPixDouble*ConPix]];
% end
...
[Salpix(rowind, colind),cSal]=VAMC_TargetSegmentation_Hops(SP);
