...
% % to discard the outlier 주변과 하나도 안닮은애(기본 자기자신과 1이니까
% % 주변연결된애들이랑 similiarity합이 0.1보다 작은애, 이거에 걸리면 못나가서 saliency 개높음.
% % %그래서 지우고 생각.
...
%%%%%%%%%%%% absorb MC
if NumIn == k
    BaseEdg = sum( EdgWcon, 2 )*6; %얼마나 neighbor인 boundary sup와 닮아있는가
